...
void iftKMeans(iftDataSet *Z, int n_clusters, int max_iter, float tol, int *init_centroids, iftCentroidsHist *centroids_hist);
...
bool iftCentroidsConverged(iftDataSet *Z, float **curr_centroids, float **prev_centroids, float tol);
